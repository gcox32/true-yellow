...
CeladonMart5FClerk1Text::
	script_mart TM_TELEPORT, TM_DOUBLE_TEAM, TM_REFLECT, TM_EGG_BOMB, TM_SKULL_BASH, TM_SKY_ATTACK, TM_REST, TM_THUNDER_WAVE, TM_EXPLOSION

CeladonMart5FClerk2Text::
	script_mart HP_UP, IRON, PROTEIN, CARBOS, CALCIUM, PP_UP

FuchsiaMartClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, HYPER_POTION, REVIVE, FULL_HEAL, SUPER_REPEL, RARE_CANDY
