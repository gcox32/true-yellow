...
TypeEffects:
	...
	db GROUND,		 GHOST,		    NO_EFFECT ; buff ghost
	db GROUND,       FLOATING,      NO_EFFECT ; new type
	...
	db GHOST,        PSYCHIC_TYPE,  SUPER_EFFECTIVE ; CHANGED: buff ghost
	...
	;; Brock's Onix
	db ELECTRIC,     BROCK_TYPE,    NOT_VERY_EFFECTIVE
	db POISON,		 BROCK_TYPE,    NOT_VERY_EFFECTIVE
	db BUG,			 BROCK_TYPE,    NOT_VERY_EFFECTIVE
	;; new type for BONEMERANG, redundant with GROUND + hits FLYING
	...
	db BONEMERANG_TYPE,   GHOST,    NO_EFFECT
