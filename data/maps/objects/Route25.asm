...
Route25_Object:
	...
	def_warp_events
	warp_event 45,  4, BILLS_HOUSE, 1

	def_bg_events
	bg_event 43,  4, TEXT_ROUTE25_BILL_SIGN
	...
	object_event 24,  4, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_ROUTE25_COOLTRAINER_M, OPP_JR_TRAINER_M, 2 ; SPRITE_COOLTRAINER_M not in SPRITESET_PEWTER_CERULEAN
