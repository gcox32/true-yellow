...
GameCorner_Object:
	...
	object_event  8, 11, SPRITE_BEAUTY, STAY, LEFT, TEXT_GAMECORNER_MIDDLE_AGED_WOMAN ; sprite reused: indoor maps only have 6 NPC sprite slots
	object_event  8, 14, SPRITE_GYM_GUIDE, STAY, LEFT, TEXT_GAMECORNER_GYM_GUIDE
	object_event 11, 15, SPRITE_MIDDLE_AGED_MAN, STAY, RIGHT, TEXT_GAMECORNER_GAMBLER ; sprite reused: indoor maps only have 6 NPC sprite slots
