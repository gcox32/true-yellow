...
Route6_Object:
	...
	def_object_events
	object_event 10, 21, SPRITE_SUPER_NERD, STAY, RIGHT, TEXT_ROUTE6_SUPER_NERD1, OPP_JR_TRAINER_M, 10
	...
	object_event 11, 31, SPRITE_SUPER_NERD, STAY, LEFT, TEXT_ROUTE6_SUPER_NERD2, OPP_JR_TRAINER_M, 5
