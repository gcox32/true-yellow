	...
	const_export PEWTERCITY_YOUNGSTER2
...
PewterCity_Object:
	...
	object_event 17, 25, SPRITE_YOUNGSTER, STAY, NONE, TEXT_PEWTERCITY_COOLTRAINER_M ; previously COOLTRAINER_M but unique sprites needed to be reduced
