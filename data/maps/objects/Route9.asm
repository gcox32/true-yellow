...
Route9_Object:
	...
	object_event 24,  7, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_ROUTE9_COOLTRAINER_M1, OPP_YOUNGSTER, 14 ; SPRITE_COOLTRAINER_M not in SPRITESET_PEWTER_CERULEAN
	object_event 31,  7, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_ROUTE9_COOLTRAINER_M2, OPP_JR_TRAINER_M, 8 ; SPRITE_COOLTRAINER_M not in SPRITESET_PEWTER_CERULEAN
