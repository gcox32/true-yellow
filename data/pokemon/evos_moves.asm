...
EvosMovesPointerTable:
	...
	dw EmptyEvosMoves ; real missingno
	dw EmptyEvosMoves ; Fossil Kabutops
	dw EmptyEvosMoves ; Fossil aerodactyl
	dw EmptyEvosMoves ; GHOST
	dw OddishEvosMoves
	dw GloomEvosMoves
...
; set empty set once to save space
EmptyEvosMoves:
; Evolutions
	db 0
; Learnset
