...
Route6TrainerHeader0:
	trainer EVENT_BEAT_ROUTE_6_TRAINER_0, 0, Route6SuperNerd1BattleText, Route6SuperNerd1EndBattleText, Route6SuperNerd1AfterBattleText
...
Route6TrainerHeader3:
	trainer EVENT_BEAT_ROUTE_6_TRAINER_3, 3, Route6SuperNerd2BattleText, Route6SuperNerd2EndBattleText, Route6SuperNerd2AfterBattleText
...
Route6SuperNerd1Text:
	text_asm
	ld hl, Route6TrainerHeader0
	call TalkToTrainer
	jp TextScriptEnd

Route6SuperNerd1BattleText:
	text_far _Route6SuperNerd1BattleText
	text_end

Route6SuperNerd1EndBattleText:
	text_far _Route6SuperNerd1EndBattleText
	text_end

Route6SuperNerd1AfterBattleText:
	text_far _Route6SuperNerd1AfterBattleText
	text_end
...
Route6SuperNerd2Text:
	text_asm
	ld hl, Route6TrainerHeader3
	call TalkToTrainer
	jp TextScriptEnd

Route6SuperNerd2BattleText:
	text_far _Route6SuperNerd2BattleText
	text_end

Route6SuperNerd2EndBattleText:
	text_far _Route6SuperNerd2EndBattleText
	text_end

Route6SuperNerd2AfterBattleText:
	text_far _Route6SuperNerd2AfterBattleText
	text_end
