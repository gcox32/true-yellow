...
DEF SPECIAL EQU const_value
	const TRI          ; $11 ADDED: used with tri attack
	const FLOATING     ; $12 ADDED: used with floating magneton / weezing, can upgrade yours in specific places
	const MAGMA        ; $13 ADDED: used with volcanic magmar
	const FIRE         ; $14
	const WATER        ; $15
	const GRASS        ; $16
	const ELECTRIC     ; $17
